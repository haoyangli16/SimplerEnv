...
| Environment (Task)                              | Robot                    |
|-------------------------------------------------|--------------------------|
| GraspSingleOpenedCokeCanInScene-v0              | google_robot_static      |
| MoveNearGoogleBakedTexInScene-v1                | google_robot_static      |
| OpenDrawerCustomInScene-v0                      | google_robot_static      |
| CloseDrawerCustomInScene-v0                     | google_robot_static      |
| PlaceIntoClosedDrawerCustomInScene-v0           | google_robot_static      |
| PutCarrotOnPlateInScene-v0                      | widowx                   |
| PutSpoonOnTableClothInScene-v0                  | widowx                   |
| StackGreenCubeOnYellowCubeBakedTexInScene-v0    | widowx                   |
| PutEggplantInBasketScene-v0                     | widowx_sink_camera_setup |
